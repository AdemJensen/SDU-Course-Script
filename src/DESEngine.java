...
public class DESEngine {
    ...
    public static void main(String[] args) {
        String code = new DESEngine().encode("201805301344rtl20000214LT-5805-LgTbCnE7uTj2ejcnSoMWxShQIpfWjN-cas", "1", "2", "3");
        System.out.println(code);
        System.out.println(new DESEngine().decode(code, "1", "2", "3"));
    }
